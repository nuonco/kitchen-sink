...
echo "=== Logs (API) ==="
kubectl logs -n relay -l app.kubernetes.io/component=api --tail=100 2>&1 || true
echo "=== Logs (UI) ==="
kubectl logs -n relay -l app.kubernetes.io/component=ui --tail=100 2>&1 || true

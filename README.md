...
A read-only self-hosted infrastructure console, packaged as a Nuon app that exercises the full platform: Helm charts, Pulumi infrastructure, container images, actions, roles, and policies.
...
| **Triggers** | External events that start a rollout — [`triggers.toml`](./triggers.toml) |

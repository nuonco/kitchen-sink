...
// (branches/all.toml, runbooks/, actions/, permissions/, break_glass.toml,
...
while (repoRoot !== '/' && !existsSync(join(repoRoot, 'branches', 'all.toml'))) {
  repoRoot = dirname(repoRoot)
}

if (!existsSync(join(repoRoot, 'branches', 'all.toml'))) {
...
const branch = toml('branches/all.toml')
...
const branchConfigAbridged = read('branches/all.toml')
  .split('\n')
...
// Comment-stripped real file, same treatment as branches/all.toml above.
